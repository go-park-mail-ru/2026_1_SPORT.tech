...
CREATE TABLE content_notification (
  ...
  user_id         bigint NOT NULL,
  type            text   NOT NULL CHECK (type IN ('comment', 'donation', 'like', 'post', 'subscription', 'meeting')),
...
INSERT INTO content_subscription_tier (trainer_user_id, tier_id, name, price, description, chat_enabled, calendar_enabled)
VALUES
  (1001, 1, 'Базовый',        500,  'Доступ к открытым тренировочным материалам и базовым планам.',          false, false),
  (1001, 2, 'Продвинутый',   1500,  'Закрытые темповые тренировки, недельные планы и разбор нагрузки.',      true,  true),
  (1003, 1, 'Базовый',        600,  'Материалы по технике плавания и дыханию.',                              false, true),
  (1004, 1, 'Базовый',        400,  'Короткие комплексы йоги для ежедневной практики.',                      false, false),
  (1004, 2, 'Глубокая практика', 1200, 'Закрытые комплексы растяжки и восстановления.',                     true,  true),
  (1005, 1, 'Базовый',        700,  'Базовая техника бокса и работа ног.',                                   false, false),
  (1005, 2, 'Спарринг',      1400,  'Расширенные упражнения для защиты и контратак.',                        false, false),
  (1005, 3, 'Премиум',       2200,  'Подробные закрытые разборы защитных действий.',                         true,  true),
  (1006, 1, 'Базовый',        500,  'Домашние силовые тренировки без инвентаря.',                            false, false),
  (1006, 2, 'Прогрессия',    1300,  'Закрытые программы прогрессии и контроля нагрузки.',                   true,  true),
  (1007, 1, 'Базовый',        600,  'Материалы по технике велотренировок.',                                  false, false),
  (1007, 2, 'План подготовки',1500, 'Закрытые месячные планы велоподготовки.',                               true,  true);
...
VALUES
  ...
  (2404, 1002, 1003, 1, true, now() + INTERVAL '30 days'),
  (2405, 1002, 1004, 2, true, now() + INTERVAL '30 days'),
  (2406, 1002, 1005, 3, true, now() + INTERVAL '30 days'),
  (2407, 1002, 1006, 2, true, now() + INTERVAL '30 days'),
  (2408, 1002, 1007, 2, true, now() + INTERVAL '30 days');
