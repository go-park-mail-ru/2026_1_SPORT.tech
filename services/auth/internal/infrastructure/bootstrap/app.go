...
import (
	...
	cryptoadapter "github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/adapters/client/crypto"
	grpcadapter "github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/adapters/grpc"
	postgresadapter "github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/adapters/repository/postgres"
	"github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/infrastructure/config"
	dbinfra "github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/infrastructure/db"
	"github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/infrastructure/grpcserver"
	"github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/infrastructure/health"
	"github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/infrastructure/httpgateway"
	loggerinfra "github.com/go-park-mail-ru/2026_1_SPORT.tech/services/auth/internal/infrastructure/logger"
...
func New(ctx context.Context, cfg config.Config) (*App, error) {
	...
	accountRepository := postgresadapter.NewAccountRepository(database)
	sessionRepository := postgresadapter.NewSessionRepository(database)
	passwordHasher := cryptoadapter.NewPasswordHasher(cfg.Auth.BcryptCost)
	tokenGenerator := cryptoadapter.NewTokenGenerator(32)
	authUseCase := usecase.NewService(
		accountRepository,
		sessionRepository,
		passwordHasher,
		tokenGenerator,
	...
	httpMux.Handle("/openapi/auth.swagger.json", httpgateway.OpenAPIHandler(cfg.OpenAPI.FilePath))
