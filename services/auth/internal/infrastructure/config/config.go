...
type PostgresConfig struct {
	...
	User                              string `yaml:"user" env:"AUTH_DB_USER" validate:"required"`
	...
	ApplicationName                   string `yaml:"application_name" env:"AUTH_DB_APPLICATION_NAME" env-default:"auth-service" validate:"required"`
	DBMaxOpenConns                    int    `yaml:"db_max_open_conns" env:"AUTH_DB_MAX_OPEN_CONNS" env-default:"12" validate:"required"`
	DBMaxIdleConns                    int    `yaml:"db_max_idle_conns" env:"AUTH_DB_MAX_IDLE_CONNS" env-default:"6" validate:"gte=0"`
	DBConnMaxLifetime                 string `yaml:"db_conn_max_lifetime" env:"AUTH_DB_CONN_MAX_LIFETIME" env-default:"30m" validate:"required"`
	DBConnectTimeoutSeconds           int    `yaml:"db_connect_timeout_seconds" env:"AUTH_DB_CONNECT_TIMEOUT_SECONDS" env-default:"5" validate:"required"`
	DBStatementTimeout                string `yaml:"db_statement_timeout" env:"AUTH_DB_STATEMENT_TIMEOUT" env-default:"5s" validate:"required"`
	DBLockTimeout                     string `yaml:"db_lock_timeout" env:"AUTH_DB_LOCK_TIMEOUT" env-default:"1s" validate:"required"`
	DBIdleInTransactionSessionTimeout string `yaml:"db_idle_in_transaction_session_timeout" env:"AUTH_DB_IDLE_IN_TRANSACTION_SESSION_TIMEOUT" env-default:"10s" validate:"required"`
}
