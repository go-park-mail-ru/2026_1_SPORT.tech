...
func New(ctx context.Context, cfg config.Config) (*App, error) {
	...
	gatewayHandler, err := httpgateway.NewMux(ctx, gatewayService, gatewayService, gatewayService, gatewayService, gatewayService, gatewayService, gatewayService, gatewayService, gatewayService, gatewayService)
	if err != nil {
		_ = authConn.Close()
		_ = profileConn.Close()
		_ = contentConn.Close()
